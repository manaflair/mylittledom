export let flags = {
    ...
    ELEMENT_HAS_DIRTY_RENDERING:          (1 << 4),
    ELEMENT_HAS_DIRTY_CLIPPING:           (1 << 5),

    ELEMENT_HAS_DIRTY_LAYOUT_CHILDREN:    (1 << 6),
    ELEMENT_HAS_DIRTY_CLIPPING_CHILDREN:  (1 << 7),
    ELEMENT_HAS_DIRTY_RENDERING_CHILDREN: (1 << 8)
